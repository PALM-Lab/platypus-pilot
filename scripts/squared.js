...
var stroop_task = { timeline: [intro_stroop, threetwoone, block_stroop_practice, premain_stroop, threetwoone, block_stroop_main, conclusion_stroop, save_stroop_data] };
...
const ar = "img/ar.PNG";
const al = "img/al.PNG";
const mr_fl = "img/mr_fl.PNG";
const ml_fr = "img/ml_fr.PNG";
...
// Put timeline together
var flanker_task = {timeline: [intro_flanker, threetwoone, block_flanker_practice, premain_flanker, threetwoone, block_flanker_main, conclusion_flanker, save_flanker_data]};
...
const rarr = "img/rarr.PNG";
const larr = "img/larr.PNG";
...
// Put timeline together
var simon_task = {timeline: [intro_simon, threetwoone, block_simon_practice, premain_simon, threetwoone, block_simon_main, conclusion_simon, save_simon_data]};
